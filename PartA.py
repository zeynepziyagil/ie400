...
try:
  ...
  """
    KL
    Vk=1 >> sum|l->5(Rkl[k][l]) >= 1
    Vk>0 >> sum|l->5(Rkl[k][l]) >= 1

    Vk<=0
    1-sum|l->5(Rkl[k][l]) <= 0

    Vk<=Mz
    1-sum|l->5(Rkl[k][l]) <= M(1-z)

    M=1
    Vk<=z
    sum|l->5(Rkl[k][l]) >= z
    z={0,1} for k = {0,1,2,3,4}

    LK
    Vk=1 >> sum|k->5(Rkl[l][k]) >= 1
    Vk>0 >> sum|k->5(Rkl[l][k]) >= 1

    Vk<=0
    1-sum|l->5(Rkl[l][k]) <= 0

    Vk<=Mz
    1-sum|l->5(Rkl[l][k]) <= M(1-z) 1-z

    M=1
    Vk<=z
    sum|l->5(Rkl[l][k]) >= z
    z={0,1} for l = {0,1,2,3,4}
  """
  ...
  """
  sum|k(Vk) > 2 >> R0k + Rk0 <= 1
  sum|k(Vk) - 2 > 0 >> R0k + Rk0 - 1 <= 0
  
  sum|k(Vk) - 2 <= 0
  R0k + Rk0 - 1 <= 0

  sum|k(Vk) - 2 <= Mz
  R0k + Rk0 - 1 <= M(1-z) 5 - 5z
